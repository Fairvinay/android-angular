...
public class AppAuthConfiguration {
  ...
  public String toString() {
    return "AppAuthConfiguration{" +
      "mBrowserMatcher=" + (mBrowserMatcher !=null ? mBrowserMatcher : "mBrowserMatcher -> null")  +
      ", mConnectionBuilder=" + (mConnectionBuilder !=null ? mConnectionBuilder : "mConnectionBuilder -> null" )+
      ", mSkipIssuerHttpsCheck=" + mSkipIssuerHttpsCheck +
      '}';
  }
